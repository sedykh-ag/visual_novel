...
option21 = Option('да', game, slide3, slide4, 1, 2)
option22 = Option('нет', game, slide4, slide3, 1, 2)
...
option11 = Option('да', game, slide2, slide3, 0, 1)
option12 = Option('нет', game, slide2, slide2, 0, 0)
